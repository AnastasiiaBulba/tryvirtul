        ...
        <header class="header fade-in">
            <div class="header-container">
                <a href="./" class="logo">
                    ...
                    <span>Tryvirtul.com</span>
                </a>
                
                <nav class="nav">
                    <ul class="nav-list">
                        <li><a href="./" class="nav-link">Home</a></li>
                        <li><a href="./kiki-news.html" class="nav-link">Updates</a></li>
                        <li><a href="./kiki-contacts.html" class="nav-link">Support</a></li>
                    </ul>
                </nav>
            ...
            <div class="mobile-menu">
                <div class="mobile-menu-content">
                    ...
                    <ul class="mobile-menu-list">
                        ...
                        <li><a href="./kiki-news.html" class="mobile-menu-link">Updates</a></li>
                        <li><a href="./kiki-contacts.html" class="mobile-menu-link">Support</a></li>
                    </ul>
                </div>
            </div>
        </header>
