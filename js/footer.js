            ...
            <div class="footer-container">
                <div class="footer-content">
                    <div class="footer-section">
                        ...
                        <div class="footer-contact">
                            <div class="contact-item">
                                ...
                                <div class="contact-text">contact@tryvirtul.com</div>
                            </div>
                            <div class="contact-item">
                                <div class="contact-icon">📞</div>
                                <div class="contact-text">+61 89 444 444</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="footer-section">
                        ...
                        <div class="footer-links">
                            <a href="./kiki-cookies.html" class="footer-link">Cookie Policy</a>
                            <a href="./kiki-privacy.html" class="footer-link">Privacy Policy</a>
                            <a href="./kiki-disclaimer.html" class="footer-link">Disclaimer</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-bottom">
                    <div class="copyright">
                        ...
                        Tryvirtul.com. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
